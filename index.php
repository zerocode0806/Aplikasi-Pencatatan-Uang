...
if (isset($_POST['login'])) {
  ...
  $query = mysqli_query($conn, "SELECT * FROM user WHERE usernama='$username' AND password='$password'");
...
if (isset($_POST['signup'])) {
  ...
  $cek = mysqli_query($conn, "SELECT * FROM user WHERE usernama='$username'");
  if (mysqli_num_rows($cek) > 0) {
    $error = "Username sudah digunakan!";
  } else {
    mysqli_query($conn, "INSERT INTO user (nama, usernama, password, level) VALUES ('$nama', '$username', '$password', 'user')");
